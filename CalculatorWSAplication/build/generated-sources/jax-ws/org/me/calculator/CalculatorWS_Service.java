 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://calculator.me.org/", wsdlLocation = "http://localhost:8080/CalculatorWSAplication/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/CalculatorWSAplication/CalculatorWS?wsdl");
